...
$loggedInEmail = 'pickpack@pentagon.com'; // Replace with actual logged-in user's email

// Determine the department based on the logged-in user's email
if ($loggedInEmail == 'pickpack@pentagon.com') {
    $departmentFilter = "AND dept = 'pickpack'";
} else {
