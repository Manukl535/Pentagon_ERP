...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="pp_orders.php" class="w3-bar-item w3-button w3-padding w3-brown"><i style="font-size:15px" class="fa">&#xf0ae;</i>&nbsp; Stock</a>
            <div style="margin-top: 10px;"></div>
            <a href="customer.php" class="w3-bar-item w3-button w3-padding w3-green"><i style="font-size:15px" class="fa">	&#xf0c0;</i>&nbsp; Sales</a>
            <div style="margin-top: 10px;"></div>
            <a href="customer.php" class="w3-bar-item w3-button w3-padding w3-red"><i style="font-size:15px" class="fa">	&#xf03a;</i>&nbsp; Audit report</a>
            <div style="margin-top: 10px;"></div>
